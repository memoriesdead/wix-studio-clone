...
export const UpdateProjectDataCacheSecurity$inboundSchema = z.object({
    ...
    managedRules: z.nullable(z.record(z.lazy(() => UpdateProjectDataCacheManagedRules$inboundSchema))).optional(),
});
/** @internal */
export const UpdateProjectDataCacheSecurity$outboundSchema = z.object({
    ...
    ja4Enabled: z.boolean().optional(),
    firewallBypassIps: z.array(z.string()).optional(),
    managedRules: z.nullable(z.record(z.lazy(() => UpdateProjectDataCacheManagedRules$outboundSchema))).optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
