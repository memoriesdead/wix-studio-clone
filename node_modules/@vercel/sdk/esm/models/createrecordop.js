...
/** @internal */
export const CreateRecordRequestBody3$inboundSchema = z.object({
    name: z.string(),
...
/** @internal */
export const CreateRecordRequestBody3$outboundSchema = z.object({
    name: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CreateRecordRequestBody3$;
(function (CreateRecordRequestBody3$) {
...
export function createRecordRequestBody3ToJSON(createRecordRequestBody3) {
    return JSON.stringify(CreateRecordRequestBody3$outboundSchema.parse(createRecordRequestBody3));
}
export function createRecordRequestBody3FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateRecordRequestBody3$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateRecordRequestBody3' from JSON`);
}
/** @internal */
...
/** @internal */
export const CreateRecordRequestBody2$inboundSchema = z.object({
    name: z.string(),
...
/** @internal */
export const CreateRecordRequestBody2$outboundSchema = z.object({
    name: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CreateRecordRequestBody2$;
(function (CreateRecordRequestBody2$) {
...
export function createRecordRequestBody2ToJSON(createRecordRequestBody2) {
    return JSON.stringify(CreateRecordRequestBody2$outboundSchema.parse(createRecordRequestBody2));
}
export function createRecordRequestBody2FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateRecordRequestBody2$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateRecordRequestBody2' from JSON`);
}
/** @internal */
...
/** @internal */
export const CreateRecordRequestBody1$inboundSchema = z.object({
    name: z.string(),
...
/** @internal */
export const CreateRecordRequestBody1$outboundSchema = z.object({
    name: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CreateRecordRequestBody1$;
(function (CreateRecordRequestBody1$) {
...
export function createRecordRequestBody1ToJSON(createRecordRequestBody1) {
    return JSON.stringify(CreateRecordRequestBody1$outboundSchema.parse(createRecordRequestBody1));
}
export function createRecordRequestBody1FromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateRecordRequestBody1$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateRecordRequestBody1' from JSON`);
}
/** @internal */
