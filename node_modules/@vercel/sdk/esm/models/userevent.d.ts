...
export declare const UserEventPayload73Role: {
...
/** @internal */
export declare const UserEventPayload83Team$inboundSchema: z.ZodType<UserEventPayload83Team, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventPayload83Team$outboundSchema: z.ZodType<UserEventPayload83Team$Outbound, z.ZodTypeDef, UserEventPayload83Team>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload83Team$ {
    /** @deprecated use `UserEventPayload83Team$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload83Team, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload83Team$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload83Team$Outbound, z.ZodTypeDef, UserEventPayload83Team>;
    /** @deprecated use `UserEventPayload83Team$Outbound` instead. */
    type Outbound = UserEventPayload83Team$Outbound;
}
...
/** @internal */
export declare const UserEventPayload83Project$outboundSchema: z.ZodType<UserEventPayload83Project$Outbound, z.ZodTypeDef, UserEventPayload83Project>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload83Project$ {
    /** @deprecated use `UserEventPayload83Project$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventPayload83Project, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventPayload83Project$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventPayload83Project$Outbound, z.ZodTypeDef, UserEventPayload83Project>;
    /** @deprecated use `UserEventPayload83Project$Outbound` instead. */
    type Outbound = UserEventPayload83Project$Outbound;
}
export declare function userEventPayload83ProjectToJSON(userEventPayload83Project: UserEventPayload83Project): string;
...
/** @internal */
export declare const UserEventPayload73Role$inboundSchema: z.ZodNativeEnum<typeof UserEventPayload73Role>;
/** @internal */
export declare const UserEventPayload73Role$outboundSchema: z.ZodNativeEnum<typeof UserEventPayload73Role>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventPayload73Role$ {
