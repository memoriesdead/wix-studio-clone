...
/** @internal */
export const CreateTeamBilling$inboundSchema = z.object({});
/** @internal */
export const CreateTeamBilling$outboundSchema = z.object({});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CreateTeamBilling$;
(function (CreateTeamBilling$) {
    /** @deprecated use `CreateTeamBilling$inboundSchema` instead. */
    CreateTeamBilling$.inboundSchema = CreateTeamBilling$inboundSchema;
    /** @deprecated use `CreateTeamBilling$outboundSchema` instead. */
    CreateTeamBilling$.outboundSchema = CreateTeamBilling$outboundSchema;
})(CreateTeamBilling$ || (CreateTeamBilling$ = {}));
export function createTeamBillingToJSON(createTeamBilling) {
    return JSON.stringify(CreateTeamBilling$outboundSchema.parse(createTeamBilling));
}
export function createTeamBillingFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CreateTeamBilling$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CreateTeamBilling' from JSON`);
}
/** @internal */
