...
export const GetProjectsSecurity$inboundSchema = z.object({
    ...
    managedRules: z.nullable(z.record(z.lazy(() => GetProjectsManagedRules$inboundSchema))).optional(),
});
/** @internal */
export const GetProjectsSecurity$outboundSchema = z.object({
    ...
    ja4Enabled: z.boolean().optional(),
    firewallBypassIps: z.array(z.string()).optional(),
    managedRules: z.nullable(z.record(z.lazy(() => GetProjectsManagedRules$outboundSchema))).optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
