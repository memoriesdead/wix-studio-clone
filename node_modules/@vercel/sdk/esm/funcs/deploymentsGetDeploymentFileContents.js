 ...
 */
export function deploymentsGetDeploymentFileContents(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.nil("2XX", z.void()), M.fail([403, 410, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
