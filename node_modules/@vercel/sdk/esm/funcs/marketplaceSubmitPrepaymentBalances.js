...
import { SubmitPrepaymentBalancesRequest$outboundSchema, } from "../models/submitprepaymentbalancesop.js";
 ...
 */
export function marketplaceSubmitPrepaymentBalances(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/installations/{integrationConfigurationId}/billing/balance")(pathParams);
