...
import { MoveProjectDomainRequest$outboundSchema, MoveProjectDomainResponseBody$inboundSchema, } from "../models/moveprojectdomainop.js";
 ...
 */
export function projectsMoveProjectDomain(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, MoveProjectDomainResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, 409, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=projectsMoveProjectDomain.js.map