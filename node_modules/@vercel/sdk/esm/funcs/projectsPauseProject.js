...
import { PauseProjectRequest$outboundSchema, } from "../models/pauseprojectop.js";
 ...
 */
export function projectsPauseProject(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.nil(200, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([402, 403, "4XX"]), M.fail([500, "5XX"]))(response, { extraFields: responseFields });
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=projectsPauseProject.js.map