...
import { UpdateIntegrationDeploymentActionRequest$outboundSchema, } from "../models/updateintegrationdeploymentactionop.js";
 ...
 */
export function integrationsUpdateIntegrationDeploymentAction(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/deployments/{deploymentId}/integrations/{integrationConfigurationId}/resources/{resourceId}/actions/{action}")(pathParams);
    ...
    const [result] = await M.match(M.nil(202, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=integrationsUpdateIntegrationDeploymentAction.js.map