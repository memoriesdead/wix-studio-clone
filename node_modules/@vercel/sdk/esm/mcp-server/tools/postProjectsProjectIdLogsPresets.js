...
export const tool$postProjectsProjectIdLogsPresets = {
    name: "post-projects-project-id-logs-presets",
    description: ``,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await postProjectsProjectIdLogsPresets(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
