...
export const tool$getProjectsProjectIdLogsPresets = {
    name: "get-projects-project-id-logs-presets",
    description: ``,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await getProjectsProjectIdLogsPresets(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
