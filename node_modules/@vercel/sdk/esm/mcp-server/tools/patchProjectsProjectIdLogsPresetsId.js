...
export const tool$patchProjectsProjectIdLogsPresetsId = {
    name: "patch-projects-project-id-logs-presets-id",
    description: ``,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await patchProjectsProjectIdLogsPresetsId(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
